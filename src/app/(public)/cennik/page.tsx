...
const PricingPage = () => {
  return (
    <section
      className="relative overflow-hidden text-foreground selection:bg-zinc-600"
    >
      <div className="relative z-10 mx-auto max-w-5xl px-4 py-20 md:px-8">
        <div className="mb-12 space-y-3">
          <Heading type={'h1'} align={'center'} className="text-3xl leading-tight sm:text-4xl sm:leading-tight md:text-5xl md:leading-tight">
            Cennik
          </Heading>
          <Text align={'center'} >
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
          <PricingCard
            ...
            CTA={<Button variant={'outline'} className="w-full">Działaj za darmo!</Button>}
            benefits={[
